class InstagramPostSchema < RubyLLM::Schema
  ...
  string :body, description: "The full caption body following the hook, including hashtags. Your character limit is 125 before the 'more' appears, don't reach that unless the user ask for it "
end
